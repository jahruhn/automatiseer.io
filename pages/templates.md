...
<div id="ai-lead-scoring" class="card">
  <p>Automatisch leads scoren op basis van interacties, gedrag en demografische gegevens. Integreert met CRM-systemen zoals HubSpot en Salesforce.</p>
  <a href="#" class="button">Download Template</a>
</div>

### LinkedIn naar HubSpot Sync
<div id="linkedin-hubspot" class="card">
  <p>Synchroniseer LinkedIn-leads direct met HubSpot. Automatisch contacten aanmaken en updates synchroniseren.</p>
  <a href="#" class="button">Download Template</a>
</div>

### Automatische Contractverlengingen
<div id="contract-verlengingen" class="card">
  <p>Herinneringen en acties voor contractverlengingen. Automatische e-mails en taken voor accountmanagers.</p>
  <a href="#" class="button">Download Template</a>
</div>
